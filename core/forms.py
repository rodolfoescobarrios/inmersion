...
class UsuarioUpdateForm(UserChangeForm):
    ...
    class Meta:
        model = Usuario
        fields = ['first_name', 'last_name', 'email', 'institucion', 'inhabilitar_cuenta']

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        del self.fields['password']  # Elimina el campo de contraseña
        self.fields['inhabilitar_cuenta'].initial = not self.instance.is_active
